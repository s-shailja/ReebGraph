...
trkfolder = '/home/shailja/Winter2021/Connectome/Data/trk/eps4'
trkfolderI = '/home/shailja/Winter2021/Connectome/Data/trk'
eps = 4
import pickle
...
for i in range(len(trknamelist)):
    ...
    trkpathI = os.path.join(trkfolderI+'/raw_data', trkname[:len(trknamelist[i])-7])
    ...
    #construct R
    R = nx.Graph()
    check_traj = np.zeros((len(I.trajectories), 2000), dtype=bool) #Flag considered points of the trajectories
    ...
    print(trkname, len(streamlines), len(R.nodes()), len(R.edges()), nx.average_clustering(R),  nx.estrada_index(R) )  
    # except:
